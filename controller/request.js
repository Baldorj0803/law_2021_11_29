...
exports.getrequest = asyncHandler(async (req, res, next) => {
  ...
  let query = `select r.id, c.name as company,i.name as gereeNer,i.subFile,i.file,i.brfMean,i.custInfo,i.wage,i.execTime,i.description,i.warrantyPeriod,i.trmCont,i.isIncludeBudget,i.pYearTTService,
